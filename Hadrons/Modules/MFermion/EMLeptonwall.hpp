...
Source file: Hadrons/Modules/MFermion/EMLeptonwall.hpp
...
#ifndef Hadrons_MFermion_EMLeptonwall_hpp_
#define Hadrons_MFermion_EMLeptonwall_hpp_
...
class EMLeptonwallPar: Serializable
{
public:
    GRID_SERIALIZABLE_CLASS_MEMBERS(EMLeptonwallPar,
				    std::string,  action,
				    std::string, emField,
				    double, mass,
                                    std::string , boundary,
...
class TEMLeptonwall: public Module<EMLeptonwallPar>
{
public:
...
public:
    // constructor
    TEMLeptonwall(const std::string name);
    // destructor
    virtual ~TEMLeptonwall(void) {};
    // dependency relation
...
MODULE_REGISTER_TMP(EMLeptonwall, TEMLeptonwall<FIMPL>, MFermion);

/******************************************************************************
 *                 TEMLeptonwall implementation                             *
 ******************************************************************************/
// constructor /////////////////////////////////////////////////////////////////
template <typename FImpl>
TEMLeptonwall<FImpl>::TEMLeptonwall(const std::string name)
: Module<EMLeptonwallPar>(name)
{}

// dependencies/products ///////////////////////////////////////////////////////
template <typename FImpl>
std::vector<std::string> TEMLeptonwall<FImpl>::getInput(void)
{
...
template <typename FImpl>
std::vector<std::string> TEMLeptonwall<FImpl>::getOutput(void)
{
...
// setup ///////////////////////////////////////////////////////////////////////
template <typename FImpl>
void TEMLeptonwall<FImpl>::setup(void)
{
...
// execution ///////////////////////////////////////////////////////////////////
template <typename FImpl>
void TEMLeptonwall<FImpl>::execute(void)
{
    ...
    sourcetmp = where((tlat == tl), sourcetmp, 0.*sourcetmp);
    	LOG(Message) << sourcetmp << std::endl;
...
#endif // Hadrons_MFermion_EMLeptonwall_hpp_
