...
Source file: extras/Hadrons/Modules/MContraction/WeakMesonDecayKl2.hpp
...
/*TODO Short description what is done here
TODO Log messages
...
public:
    GRID_SERIALIZABLE_CLASS_MEMBERS(WeakMesonDecayKl2Par,
                                    ...
                                    std::string, q2,
                                    std::string, lepton,
                                    //std::string, gammas,//Todo: Check which I need, to be versitile but not to much ^^
				    std::string, output);
};
